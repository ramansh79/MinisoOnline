    ...
    <form @submit.prevent="register(form)"                         
        ...
        <div class="mb-5 text-left ">
            ...
            <input 
                ...
                px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="name" />
        </div>
        <div class="mb-5 text-left">
            <label 
                for="email" 
            ...
            focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="name@flowbite.com"/>
        </div>
        <div class="mb-5 text-left">
            <label 
                for="password" 
